...
class AddEstimatedCost extends StatefulWidget {
  const AddEstimatedCost({super.key});

  @override
  State<AddEstimatedCost> createState() => _AddEstimatedCostState();
}

class _AddEstimatedCostState extends State<AddEstimatedCost> {
  bool change = true;
              ...
              AppBarGeneralWidget(
                backPage: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const MakingDeliveryOnly(),
                    ),
                  );
                },
                ...
                child: GreenButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const InformationAboutWarehouses(),
                      ),
                    );
                  },
                  change: false,
