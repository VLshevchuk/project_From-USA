...
import 'package:from_usa/pages/bag_tab/making_delivery_only/add_invoice.dart';
import 'package:from_usa/pages/bag_tab/making_delivery_only/widgets/app_bar_making_delivery_only_widget.dart';
import 'package:from_usa/pages/bag_tab/making_delivery_only/widgets/bottom_button_making_delivery_only_widget.dart';
import 'package:from_usa/pages/path/to/globals.dart' as globals;

class MakingDeliveryOnly extends StatefulWidget {
  const MakingDeliveryOnly({super.key});

  @override
  State<MakingDeliveryOnly> createState() => _MakingDeliveryOnlyState();
}

class _MakingDeliveryOnlyState extends State<MakingDeliveryOnly> {
