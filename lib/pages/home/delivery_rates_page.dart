...
class DeliveryRates extends StatefulWidget {
  const DeliveryRates({super.key});

  @override
  State<DeliveryRates> createState() => _DeliveryRatesState();
}
...
class _DeliveryRatesState extends State<DeliveryRates> {
