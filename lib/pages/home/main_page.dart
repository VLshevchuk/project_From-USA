...
import 'package:from_usa/pages/botom_app_bar/box/my_parcels_main.dart';
import 'package:from_usa/pages/home/delivery_only_page.dart';
import 'package:from_usa/pages/home/delivery_rates_page.dart';
import 'package:from_usa/pages/home/purchase_and_delivery_page.dart';
                    ...
                    TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const DeliveryOnly(),
                          ),
                        );
                      },
                      child: const TextLato40pxW800(
                ...
                text: TextButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const DeliveryRates(),
                      ),
                    );
                  },
                  child:
