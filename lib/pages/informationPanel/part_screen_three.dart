...
import 'package:from_usa/pages/informationPanel/part_screen_two.dart';

import 'package:from_usa/pages/path/to/globals.dart' as globals;

import '../../help_widgets/text_widget.dart';

class PartScreenThree extends StatelessWidget {
  const PartScreenThree({super.key});
                  ...
                  TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const PartScreenTwo(),
                          ),
                        );
                      },
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const PartScreenFour(),
                        ),
                      );
                    },
                    child: const TextLato14pxW700(
