...
import 'package:from_usa/pages/profile/recipient_addresses_pages/selecting_the_recipients_address_page.dart';


class RecipientAddressesPage extends StatefulWidget {
  const RecipientAddressesPage({super.key});
                    ...
                    onPressed: () {
                      areAllFieldsFilled()
                          ? Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const SelectTheRecipientsAddressPage(),
                              ),
                            )
                          : null;
                    },
