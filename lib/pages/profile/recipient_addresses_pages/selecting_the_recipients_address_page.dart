...
class SelectTheRecipientsAddressPage extends StatefulWidget {
  const SelectTheRecipientsAddressPage({
    super.key,
  });

  @override
  State<SelectTheRecipientsAddressPage> createState() =>
      _SelectTheRecipientsAddressPageState();
}

List<String> options = ["Po1", "Oo2", '3', 'ds'];

class _SelectTheRecipientsAddressPageState
    extends State<SelectTheRecipientsAddressPage> {
...
class SelectingADeliveryPoint<T> extends StatelessWidget {
  ...
  final TextStyle? darkBlue;

  const SelectingADeliveryPoint({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: colorBox ?? const Color.fromRGBO(248, 250, 253, 1.0),
      ),
      child: ListTile(
        onTap: () {
          onChanged(
